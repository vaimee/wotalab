...
export declare class Thing implements TDT.ThingDescription {
    title: TDT.Title;
    securityDefinitions: {
    ...
    [key: string]: any;
    properties?: {
        [k: string]: TDT.PropertyElement;
    } | undefined;
    actions?: {
        [k: string]: TDT.ActionElement;
    } | undefined;
    events?: {
        [k: string]: TDT.EventElement;
    } | undefined;
    constructor();
}
...
export type SecurityType = NoSecurityScheme | BasicSecurityScheme | AutoSecurityScheme | DigestSecurityScheme | BearerSecurityScheme | APIKeySecurityScheme | OAuth2SecurityScheme | PSKSecurityScheme | AllOfSecurityScheme | OneOfSecurityScheme;
